    ...
    <div className="bg-sky-200 min-h-screen p-12 font-mono">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-12">
        <div className="flex justify-center">
          ...
          {/* {!isEditMode && (
        <button className="bg-blue-500 text-white rounded p-2 ml-2" onClick={handleEditClick}>
          Edit
        </button>
      )} */}
        </div>
        ...
        {/* <div className="grid grid-cols-3 mb-16 gap-8">
          <div>
            <div>
            ...
            <div className="grid grid-cols-3">
              <p className="font-bold">Name</p>
              <p className="col-span-2">Rithik Raj</p>
              <p className="font-bold">DOB</p>
              <p className="col-span-2">06/04/2004</p>
              <p className="font-bold">Gender</p>
          ...
          <div>
            ...
            <div className="grid grid-cols-3">
              <p className="font-bold">Email</p>
              <p className="cols-span-2">rithu0644@gmail.com</p>
              <p className="font-bold">Mobile</p>
              <p className="cols-span-2">9345049320</p>
            </div>
          </div>
