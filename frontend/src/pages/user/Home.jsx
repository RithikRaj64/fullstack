            ...
            <div className="bg-white p-14 rounded-lg min-h-fit font-mono space-y-32">
                <div className="grid grid-cols-2 space-x-20">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <a href="/user/courses" className="inline-flex justify-center text-white bg-blue-600 hover:bg-sky-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                            Browse Courses
                ...
                <div className="grid grid-cols-2 space-x-2">
                    <div className="flex flex-col justify-center pr-14">
                        ...
                        <a href="/user/institutes" className="inline-flex justify-center text-white bg-blue-600 hover:bg-sky-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                            Browse Institutes
                            <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2 mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                            </svg>
