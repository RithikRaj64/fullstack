                ...
                <div className="grid grid-cols-3 space-x-20">
                    ...
                    <div className="col-span-2 flex justify-center items-center">
                        <div>
                            ...
                            <a href="/user/courses/selected" className="inline-flex text-white bg-blue-600 hover:bg-sky-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
