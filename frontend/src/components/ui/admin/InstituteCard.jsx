    ...
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-xl shadow m-5">
            ...
            <div className="p-5 font-mono">
                ...
                <div className="flex flex-row justify-center space-x-2 text-sm">
                    <a href="#" className="inline-flex text-white bg-sky-600 hover:bg-sky-800  px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                        View Details
                    ...
                    <a href="#" className="inline-flex text-white bg-red-600 hover:bg-red-800 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:ring-red-300 focus:outline-none">
                        Delete
