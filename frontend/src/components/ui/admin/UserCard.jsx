...
function UserCard() {
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-xl shadow m-5 p-8 tracking-tighter flex flex-col items-center">
            ...
            <p>Rithik Raj</p>
            <p>Age : 19</p>
            <a href="/admin/user/6" className="inline-flex text-white bg-blue-600 hover:bg-sky-800 hover:px-5 px-3 py-2 mt-5 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                View Details
